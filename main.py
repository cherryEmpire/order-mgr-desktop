...
from PySide6.QtCore import QFile, QElapsedTimer, QByteArray
...
class MainApp:
    ...
    def __init__(self) -> None:
        ...
        self.splash.setWindowIcon(QIcon(':/icon/icons/main.png'))
        self.splash.init_ui()
        self.splash.show()
        ...
        self.login_form.setWindowIcon(QIcon(':/icon/icons/main.png'))
