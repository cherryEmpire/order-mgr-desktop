...
class OrderDetailForm(QDialog):
    ...
    def init_ui(self, current_user, order_id, new_add: bool):
        ...
        self.header_detail_layout.setContentsMargins(0,0,0,0)
        self.header_detail_layout.setSpacing(5)
        self.header_label1 = QLabel('购买单位:', self)
        self.header_label2 = QLineEdit(self)
        self.header_label2.setObjectName('cell-edit-info')
        self.header_label2.setFixedWidth(200)
        self.header_label3 = QLabel('客户:', self)
        self.header_label4 = QLineEdit(self)
        self.header_label4.setObjectName('cell-edit-info')
        self.header_label4.setFixedWidth(200)
        self.header_label5 = QLabel('联系电话:', self)
        self.header_label6 = QLineEdit(self)
        self.header_label6.setObjectName('cell-edit-info')
        self.header_label6.setFixedWidth(200)
        ...
        self.tail_row3_label2.setObjectName('cell-edit-info')
        self.tail_row3_label2.setFixedWidth(200)
        self.tail_row3_label3 = QLabel('经手人:', self)
        self.tail_row3_label4 = QLineEdit(self)
        self.tail_row3_label4.setObjectName('cell-edit-info')
        self.tail_row3_label4.setFixedWidth(200)
        self.tail_row3_label5 = QLabel('送货人:', self)
        self.tail_row3_label6 = QLineEdit(self)
        self.tail_row3_label6.setObjectName('cell-edit-info')
        self.tail_row3_label6.setFixedWidth(200)
        self.tail_row3_label7 = QLabel('收货人:', self)
        self.tail_row3_label8 = QLineEdit(self)
        self.tail_row3_label8.setObjectName('cell-edit-info')
        self.tail_row3_label8.setFixedWidth(200)
    ...
    def init_table(self):
        ...
        self.table_view_main_layout.setContentsMargins(0,0,0,0)
        ...
        self.table_view_button_layout.setContentsMargins(0,0,0,0)
